...
namespace BibliotecaAPITests.PruebasUnitarias.Controllers.V1
{
    ...
    public class UsuariosControllerPruebas : BasePruebas
    {
        ...
        public void Setup()
        {
            ...
            {
                {
                    "llavejwt", "fdlasfñlasoj3jlldñfljlasfkasñlflasfjñlLFÑLASJDÑFLJAf"
                }
            };
        ...
        public async Task Registrar_DevuelveValidationProblem_CuandoNoEsExitoso()
        {
            ...
            var credenciales = new CredencialesUsuarioDTO { Email = "jornas@gmail.com", Password = "aA123456-" };

            userManager.CreateAsync(Arg.Any<Usuario>(), Arg.Any<string>()).Returns(
                IdentityResult.Failed(
                    new IdentityError { Code = "prueba", Description = mensajeDeError }
                    ));
