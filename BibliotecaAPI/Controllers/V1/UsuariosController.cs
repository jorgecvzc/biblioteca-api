...
namespace BibliotecaAPI.Controllers.V1
{
    ...
    public class UsuariosController : ControllerBase
    {
        ...
        public UsuariosController(
            UserManager<Usuario> userManager, IConfiguration configuration,
        ...
        [HttpPost("login", Name = "LoguearUsuarioV1")]
        ...
        [HttpPut("fn", Name = "ActualizarUsuarioV1")]
        [Authorize]
        ...
        [HttpPost("hacer-admin", Name = "DarPermisosAdminUsuarioV1")]
        [Authorize(Policy = "esadmin")]
        ...
        [HttpPost("borrar-admin", Name = "QuitarPermisosAdminUsuarioV1")]
        [Authorize(Policy = "esadmin")]
        public async Task<ActionResult> BorrarAdmin(EditarClaimDTO editarClaimDTO)
        {
            var usuario = await userManager.FindByEmailAsync(editarClaimDTO.Email);
        ...
        private async Task<RespuestaAutenticacionDTO> ConstruirToken(CredencialesUsuarioDTO credencialesUsuarioDTO)
        {
            var claims = new List<Claim>
            {
                ...
                new Claim("loqueyoquiera", "cualquiervalor")
            };
            ...
            var expiracion = DateTime.UtcNow.AddYears(15);
