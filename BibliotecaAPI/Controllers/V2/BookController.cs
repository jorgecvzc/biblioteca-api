...
namespace BibliotecaAPI.Controllers.V2
{
    ...
    public class BookController : ControllerBase
    {
        ...
        [HttpGet("{id:int}", Name = "ObtenerLibroV2")] // api/V2/books/id
        [AllowAnonymous]
        [OutputCache(Tags = [cache])]
        ...
        public async Task<ActionResult> Post(BookCreacionDTO bookCreacionDTO)
        {
            ...
            return CreatedAtRoute("ObtenerLibroV2", new { id = book.Id }, bookCreacionDTO);
        }
        ...
        [HttpPut("{id:int}")] // api/V2/books/id
        [ServiceFilter<FiltroValidacionLibro>]
        ...
        [HttpDelete("{id:int}")] // api/V2/books/id
