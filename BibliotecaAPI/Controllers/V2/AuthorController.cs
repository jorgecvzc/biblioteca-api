...
namespace BibliotecaAPI.Controllers.V2
{
    ...
    public class AuthorController : ControllerBase
    {
        ...
        public async Task<IEnumerable<AuthorDTO>> Get([FromQuery] PaginacionDTO paginacionDTO)
        {
            return await servicioAutoresV1.Get(paginacionDTO);
        }

        [HttpGet("{id:int}", Name = "ObtenerAutorV2")] // api/V2/authors/id?incluirLibros=true|false &
        [AllowAnonymous]
        ...
        [OutputCache(Tags = [cache])]
        public async Task<ActionResult<AuthorConLibrosDTO>> Get(
            [FromRoute] [Description("El id del autor")] int id, bool incluirLibros = false)
        {
            ...
            {
                return mapper.Map<AuthorConLibrosDTO>(autor);
            }
        }
        ...
        public async Task<ActionResult> Post([FromBody] AuthorCreacionDTO authorCreDTO)
        {
            ...
            return CreatedAtRoute("ObtenerAutorV2", new { id = author.Id }, authorDTO);
        }
        ...
        [HttpPut("{id:int}")] // api/V2/authors/id
        ...
        [HttpDelete("{id:int}")] // api/V2/authors/id
